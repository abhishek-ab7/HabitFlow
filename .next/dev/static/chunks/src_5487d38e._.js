...
class SyncEngine {
   ...
   */ deduplicateByKey(items, keyFn) {
    ...
    async syncMoodLogs() {
        ...
        if (error) throw error;
        const localMoods = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"].moodLogs.where('date').aboveOrEqual(startDate).toArray();
        ...
        // Upsert local
        if (toUpsertLocal.length > 0) {
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"].transaction('rw', __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"].moodLogs, async ()=>{
                for (const log of toUpsertLocal){
                    await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"].moodLogs.put(log);
                }
            });
...
const useHabitStore = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zustand$2f$esm$2f$react$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["create"])((set, get)=>({
        ...
        loadArchivedHabits: async ()=>{
            ...
            try {
                return await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getArchivedHabits"])(session.user.id);
            } catch (error) {
        ...
        editHabit: async (id, data)=>{
            ...
            const fullHabit = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"].habits.get(id);
            set((state)=>{
        ...
        freezeHabit: async (habitId, date)=>{
            ...
            if (isCurrentlyFrozen) {
                const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["unfreezeCompletion"])(habitId, date, session.user.id);
                set((state)=>{
                    const filtered = state.completions.filter((c)=>!(c.habitId === habitId && c.date === date));
                    return {
                        completions: [
            ...
            const dateObj = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$parseISO$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseISO"])(date);
            const startStr = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$startOfWeek$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["startOfWeek"])(dateObj, {
                weekStartsOn: 1
            }), 'yyyy-MM-dd');
            const endStr = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$endOfWeek$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["endOfWeek"])(dateObj, {
                weekStartsOn: 1
            }), 'yyyy-MM-dd');
            const hasWeeklyFreeze = get().completions.some((c)=>c.status === 'frozen' && c.date >= startStr && c.date <= endStr);
            if (hasWeeklyFreeze) {
                const success = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$stores$2f$gamification$2d$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useGamificationStore"].getState().useShield();
                if (!success) {
        ...
        updateNote: async (habitId, date, note)=>{
            ...
            const { data: { session } } = await supabase.auth.getSession();
            if (!session?.user?.id) throw new Error("User not authenticated");
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updateCompletionNote"])(habitId, date, note, session.user.id);
            set((state)=>{
                const filtered = state.completions.filter((c)=>!(c.habitId === habitId && c.date === date));
                return {
                    completions: [
        ...
        updateValue: async (habitId, date, value)=>{
            ...
            const { data: { session } } = await supabase.auth.getSession();
            if (!session?.user?.id) throw new Error("User not authenticated");
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updateCompletionValue"])(habitId, date, value, session.user.id);
...
function SyncProvider({ children }) {
    ...
    const lastUserIdRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
            ...
            const initializeData = {
                "SyncProvider.useEffect.initializeData": async ()=>{
                    try {
                        ...
                        unsubscribe = syncEngine.onSyncStatusChange({
                            "SyncProvider.useEffect.initializeData": (status)=>{
                                if (active) {
                        ...
                        }["SyncProvider.useEffect.initializeData"], 30000);
                    } catch (error) {
...
_s(SyncProvider, "5HuDuNyxiyj2QAJFTzOkMEgGUe0=", false, function() {
    return [
...
_s(useKeyboardShortcuts, "o5ZI+SkIudo7k8HXWSgHRZPlXUg=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"],
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["usePathname"]
    ];
...
"[project]/src/components/ui/ShortcutsModal.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function ShortcutsModal() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ShortcutsModal.useEffect": ()=>{
            const handleKeyDown = {
                "ShortcutsModal.useEffect.handleKeyDown": (event)=>{
                    // Ignore shortcuts if the user is typing in an input/textarea
                    const active = document.activeElement;
                    if (active && (active.tagName === 'INPUT' || active.tagName === 'TEXTAREA' || active.getAttribute('contenteditable') === 'true')) {
                        return;
                    ...
                    if (event.key === '?' && event.shiftKey) {
                        event.preventDefault();
                        setIsOpen({
                            "ShortcutsModal.useEffect.handleKeyDown": (prev)=>!prev
                        }["ShortcutsModal.useEffect.handleKeyDown"]);
            ...
            const handleToggle = {
                "ShortcutsModal.useEffect.handleToggle": ()=>{
                    console.log('ShortcutsModal toggle-shortcuts event received');
                    setIsOpen({
                        "ShortcutsModal.useEffect.handleToggle": (prev)=>!prev
                    }["ShortcutsModal.useEffect.handleToggle"]);
                }
            }["ShortcutsModal.useEffect.handleToggle"];
            document.addEventListener('keydown', handleKeyDown);
...
_s(ShortcutsModal, "vl0Rt3/A8evyRPW1OQ1AhRk4UhU=");
_c = ShortcutsModal;
var _c;
__turbopack_context__.k.register(_c, "ShortcutsModal");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/src/components/layout/ShortcutsProvider.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$ShortcutsModal$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/ui/ShortcutsModal.tsx [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
'use client';
;
...
function ShortcutsProvider() {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$ShortcutsModal$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {}, void 0, false, {
        fileName: "[project]/src/components/layout/ShortcutsProvider.tsx",
        lineNumber: 8,
        columnNumber: 10
    }, this);
}
_s(ShortcutsProvider, "kYp0osVtkHT0IOo6qyNGP0vsJXI=", false, function() {
    return [
...
_c = ShortcutsProvider;
var _c;
__turbopack_context__.k.register(_c, "ShortcutsProvider");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
"[project]/src/lib/stores/pomodoro-store.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const usePomodoroStore = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zustand$2f$esm$2f$react$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["create"])((set, get)=>({
        activeTaskId: null,
        ...
        startTimer: (taskId, taskTitle)=>{
            ...
            try {
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$stores$2f$task$2d$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useTaskStore"].getState().editTask(taskId, {
                    status: 'in_progress'
                });
            } catch (e) {
...
"[project]/src/components/dashboard/premium/PomodoroFloating.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function PomodoroFloating() {
    _s();
    const { activeTaskId, activeTaskTitle, mode, timeLeft, duration, isRunning, completedSessions, pauseTimer, resumeTimer, resetTimer, tick, setMode, adjustDuration } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$stores$2f$pomodoro$2d$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["usePomodoroStore"])();
    const [isExpanded, setIsExpanded] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const [isEditingTime, setIsEditingTime] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const [customMinutes, setCustomMinutes] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(25);
    // Sync typed minutes when not editing
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "PomodoroFloating.useEffect": ()=>{
            if (!isEditingTime) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "PomodoroFloating.useEffect": ()=>{
            if (!isRunning) return;
            const interval = setInterval({
                "PomodoroFloating.useEffect.interval": ()=>{
                    tick();
                }
            }["PomodoroFloating.useEffect.interval"], 1000);
            return ({
                "PomodoroFloating.useEffect": ()=>clearInterval(interval)
            })["PomodoroFloating.useEffect"];
        }
    }["PomodoroFloating.useEffect"], [
        isRunning,
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "PomodoroFloating.useEffect": ()=>{
            const handleComplete = {
                "PomodoroFloating.useEffect.handleComplete": (e)=>{
                    const customEvent = e;
                    ...
                    if (finishedMode === 'focus') {
                        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success('Focus session complete! Take a break.', {
                            description: activeTaskTitle ? `You finished focusing on: ${activeTaskTitle}` : 'Great job focusing!',
                            duration: 5000
                        });
                    } else {
                        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success('Break finished! Let\'s get back to work.', {
                            duration: 5000
                        });
                    }
                }
            }["PomodoroFloating.useEffect.handleComplete"];
            window.addEventListener('pomodoro-complete', handleComplete);
            return ({
                "PomodoroFloating.useEffect": ()=>window.removeEventListener('pomodoro-complete', handleComplete)
            })["PomodoroFloating.useEffect"];
        }
    }["PomodoroFloating.useEffect"], [
        activeTaskTitle
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$components$2f$AnimatePresence$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AnimatePresence"], {
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["motion"].button, {
                ...
                className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("w-12 h-12 rounded-full flex items-center justify-center border shadow-lg backdrop-blur-xl bg-card/95 relative", activeColor.border),
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("svg", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("circle", {
                                ...
                                cy: "24",
                                r: "18",
                                className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("fill-none transition-all duration-300", activeColor.stroke),
                                strokeWidth: "2.5",
                                strokeDasharray: "113",
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: mode === 'focus' ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$timer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Timer$3e$__["Timer"], {
                            className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("h-4 w-4", activeColor.text)
                        }, void 0, false, {
                            fileName: "[project]/src/components/dashboard/premium/PomodoroFloating.tsx",
                            lineNumber: 156,
                            columnNumber: 17
                    ...
                    isRunning && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                        className: "absolute top-0 right-0 flex h-2 w-2",
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("animate-ping absolute inline-flex h-full w-full rounded-full opacity-75", mode === 'focus' ? "bg-rose-400" : "bg-emerald-400")
                            }, void 0, false, {
                                fileName: "[project]/src/components/dashboard/premium/PomodoroFloating.tsx",
                                lineNumber: 163,
                                columnNumber: 17
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("relative inline-flex rounded-full h-2 w-2", mode === 'focus' ? "bg-rose-500" : "bg-emerald-500")
                            }, void 0, false, {
                                fileName: "[project]/src/components/dashboard/premium/PomodoroFloating.tsx",
                                lineNumber: 164,
                                columnNumber: 17
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["motion"].div, {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            isEditingTime ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$input$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Input"], {
                                        ...
                                        onKeyDown: (e)=>{
                                            if (e.key === 'Enter') {
                                                ...
                                                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success(`Duration set to ${mins}m`);
                                ...
                                children: [
                                    !isRunning && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                                        ...
                                        onClick: ()=>{
                                            if (timeLeft > 60) {
                                                adjustDuration(-60);
                                                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success('Reduced duration by 1 minute');
                                            } else {
                                                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error('Minimum duration is 1 minute');
                                            }
                                        },
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("text-4xl font-extrabold font-mono tracking-tight text-foreground tabular-nums select-all", !isRunning && "cursor-pointer hover:text-primary transition-all hover:scale-105 transform duration-200"),
                                        onClick: ()=>{
                                            if (!isRunning) {
                                    ...
                                    !isRunning && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                                        ...
                                        onClick: ()=>{
                                            if (timeLeft < 180 * 60) {
                                                adjustDuration(60);
                                                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success('Increased duration by 1 minute');
                                            } else {
                                                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error('Maximum duration is 180 minutes');
                                            }
                                        },
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                ...
                                className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("py-1 text-[10px] font-bold rounded transition-colors", mode === 'focus' ? "bg-rose-500 text-white shadow-sm" : "text-muted-foreground hover:text-foreground"),
                                children: "Focus"
                            }, void 0, false, {
                                fileName: "[project]/src/components/dashboard/premium/PomodoroFloating.tsx",
                                lineNumber: 311,
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                ...
                                className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("py-1 text-[10px] font-bold rounded transition-colors", mode === 'short_break' ? "bg-emerald-500 text-white shadow-sm" : "text-muted-foreground hover:text-foreground"),
                                children: "Break"
                            }, void 0, false, {
                                fileName: "[project]/src/components/dashboard/premium/PomodoroFloating.tsx",
                                lineNumber: 321,
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                ...
                                className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("py-1 text-[10px] font-bold rounded transition-colors", mode === 'long_break' ? "bg-sky-500 text-white shadow-sm" : "text-muted-foreground hover:text-foreground"),
                                children: "Long"
                            }, void 0, false, {
                                fileName: "[project]/src/components/dashboard/premium/PomodoroFloating.tsx",
                                lineNumber: 331,
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    isRunning ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                                        ...
                                        size: "sm",
                                        className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("h-8 font-semibold gap-1.5 text-white", mode === 'focus' ? "bg-rose-500 hover:bg-rose-600" : "bg-emerald-500 hover:bg-emerald-600"),
                                        onClick: resumeTimer,
                                        children: [
...
_s(PomodoroFloating, "Cc+NBy5zC6Ie38Q3ng8ZBrOH4N4=", false, function() {
    return [
...
_c = PomodoroFloating;
var _c;
__turbopack_context__.k.register(_c, "PomodoroFloating");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=src_5487d38e._.js.map