...
"[project]/node_modules/date-fns/isFuture.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function isFuture(date) {
    return +(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$toDate$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toDate"])(date) > Date.now();
}
...
"[project]/node_modules/use-sound/dist/use-sound.esm.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function useSound(src, _temp) {
    ...
    var HowlConstructor = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].useRef(null);
    var isMounted = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].useRef(false);
    var _React$useState = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].useState(null), duration = _React$useState[0], setDuration = _React$useState[1];
    var _React$useState2 = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].useState(null), sound = _React$useState2[0], setSound = _React$useState2[1];
    ...
    useOnMount({
        "useSound.useOnMount": function() {
            __turbopack_context__.A("[project]/node_modules/howler/dist/howler.js [app-client] (ecmascript, async loader)").then({
                "useSound.useOnMount": function(mod) {
                    if (!isMounted.current) {
                        var _mod$Howl;
    ...
    var play = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].useCallback({
        "useSound.useCallback[play]": function(options) {
    ...
    var stop = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].useCallback({
        "useSound.useCallback[stop]": function(id) {
            if (!sound) {
                return;
            }
            sound.stop(id);
        }
    }["useSound.useCallback[stop]"], [
        sound
    ]);
    var pause = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].useCallback({
        "useSound.useCallback[pause]": function(id) {
            if (!sound) {
                return;
            }
            sound.pause(id);
        }
    }["useSound.useCallback[pause]"], [
        sound
    ]);
    var returnedValue = [
        play,
...
//# sourceMappingURL=node_modules_73c145f5._.js.map