...
async function POST(req) {
    try {
        ...
        const ai = new (await __turbopack_context__.A("[project]/src/lib/ai/service.ts [app-route] (ecmascript, async loader)")).HabitFlowAI('dashboard');
        const prompt = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$ai$2f$prompts$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["buildCoachPrompt"])({
            userData,
            context
        });
        ...
        const result = await ai.generate('coach', prompt, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$ai$2f$schemas$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["coachBriefingSchema"], body.forceRefresh ? undefined : cacheKey, cacheTTL);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__fbda69fc._.js.map