...
"[project]/src/lib/ai/schemas.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const habitRecommendationSchema = {
    type: 'object',
    properties: {
        recommendations: {
            type: 'array',
...
const milestoneGenerationSchema = {
    type: 'object',
    properties: {
        goalId: {
            type: 'string'
...
const quotePersonalizationSchema = {
    type: 'object',
    properties: {
        primaryQuote: {
            type: 'object',
...
"[project]/src/lib/ai/prompts/index.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";

// Prompt Templates for AI Features
__turbopack_context__.s([
    "buildBurnoutCheckPrompt",
    ()=>buildBurnoutCheckPrompt,
    "buildCoachPrompt",
    ()=>buildCoachPrompt,
    "buildHabitDescriptionPrompt",
    ()=>buildHabitDescriptionPrompt,
    "buildHabitRecommendationPrompt",
    ()=>buildHabitRecommendationPrompt,
    "buildHabitStackingPrompt",
    ()=>buildHabitStackingPrompt,
    "buildMilestoneGenerationPrompt",
    ()=>buildMilestoneGenerationPrompt,
    "buildPrioritizePrompt",
    ()=>buildPrioritizePrompt,
    "buildQuotePersonalizationPrompt",
    ()=>buildQuotePersonalizationPrompt,
    "buildSubtaskPrompt",
    ()=>buildSubtaskPrompt
]);
...
function buildPrioritizePrompt(input) {
...
function buildHabitRecommendationPrompt(input) {
...
function buildBurnoutCheckPrompt(input) {
...
function buildMilestoneGenerationPrompt(input) {
...
function buildHabitStackingPrompt(input) {
    const { existingHabits, userContext } = input;
    const habitList = existingHabits.map((h)=>`- ${h.name} (${h.category}, ${h.completionRate}% success rate, ${h.currentStreak} day streak)`).join('\n');
...
function buildQuotePersonalizationPrompt(input) {
...
function buildHabitDescriptionPrompt(input) {
...
"[project]/src/app/api/ai/suggest-habit-stacks/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$ai$2f$schemas$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/ai/schemas.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$ai$2f$prompts$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/ai/prompts/index.ts [app-route] (ecmascript)");
;
;
;
;
async function POST(req) {
    try {
        ...
        if (!input.existingHabits || input.existingHabits.length < 2) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'At least 2 habits are required for stacking suggestions'
            }, {
                status: 400
            });
        }
        // AI Service will handle key validation from pool
        const ai = new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$ai$2f$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["HabitFlowAI"]('habits');
        const prompt = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$ai$2f$prompts$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["buildHabitStackingPrompt"])(input);
        ...
        const result = await ai.generate('suggest-stacks', prompt, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$ai$2f$schemas$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["habitStackingSchema"], input.forceRefresh ? undefined : cacheKey, cacheTTL);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__71b1aefa._.js.map