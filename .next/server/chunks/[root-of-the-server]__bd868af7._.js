...
Make it inspiring, evidence-based, and actionable!`}e.s(["coachBriefingSchema",0,{type:"object",properties:{greeting:{type:"string"},focus:{type:"string"},quote:{type:"string"},energyForecast:{type:"string",enum:["low","medium","high"]},streaksAtRisk:{type:"array",items:{type:"string"}},quickWins:{type:"array",items:{type:"string"}},goalsDeadline:{type:"string"},weekMomentum:{type:"string",enum:["up","down","stable"]}},required:["greeting","focus","quote"]},"habitDescriptionSchema",0,{type:"object",properties:{description:{type:"string"},benefits:{type:"array",items:{type:"string"},minItems:3,maxItems:5},tips:{type:"array",items:{type:"string"},minItems:3,maxItems:5},difficultyAssessment:{type:"string",enum:["beginner","intermediate","advanced"]},estimatedTimeMinutes:{type:"number"},scientificBacking:{type:"string"},commonPitfalls:{type:"array",items:{type:"string"},maxItems:3}},required:["description","benefits","tips","difficultyAssessment","estimatedTimeMinutes"]},"habitRecommendationSchema",0,t,"habitStackingSchema",0,r,"milestoneGenerationSchema",0,i,"quotePersonalizationSchema",0,a,"subtaskGenerationSchema",0,{type:"object",properties:{subtasks:{type:"array",items:{type:"string"},minItems:3,maxItems:5}},required:["subtasks"]},"taskPrioritySchema",0,{type:"object",properties:{taskId:{type:"string"},suggestedPriority:{type:"string",enum:["low","medium","high"]},reasoning:{type:"string"},estimatedDuration:{type:"string"},bestTimeSlot:{type:"string"},dependencies:{type:"array",items:{type:"string"}},urgencyScore:{type:"number",minimum:0,maximum:100}},required:["taskId","suggestedPriority","reasoning","urgencyScore"]}],16828),e.s(["buildCoachPrompt",()=>n,"buildHabitDescriptionPrompt",()=>p,"buildHabitRecommendationPrompt",()=>o,"buildHabitStackingPrompt",()=>d,"buildMilestoneGenerationPrompt",()=>c,"buildPrioritizePrompt",()=>s,"buildQuotePersonalizationPrompt",()=>u,"buildSubtaskPrompt",()=>l],73486)},58445,e=>{"use strict";var t=e.i(47909),i=e.i(74017),r=e.i(96250),a=e.i(59756),n=e.i(61916),s=e.i(74677),o=e.i(69741),l=e.i(16795),c=e.i(87718),d=e.i(95169),u=e.i(47587),p=e.i(66012),m=e.i(70101),g=e.i(26937),h=e.i(10372),y=e.i(93695);e.i(52474);var b=e.i(5232),f=e.i(89171),v=e.i(90706),x=e.i(16828),k=e.i(73486);async function w(e){try{let t;try{t=await e.json()}catch(e){return f.NextResponse.json({error:"Invalid request body"},{status:400})}let i=t;if(!i.existingHabits||i.existingHabits.length<2)return f.NextResponse.json({error:"At least 2 habits are required for stacking suggestions"},{status:400});let r=new v.HabitFlowAI("habits"),a=(0,k.buildHabitStackingPrompt)(i),n=i.existingHabits.map(e=>e.id).sort().join(","),s=`habit-stacks:${n}`,o=await r.generate("suggest-stacks",a,x.habitStackingSchema,i.forceRefresh?void 0:s,259200);return f.NextResponse.json(o)}catch(t){console.error("Habit Stacking Route Error:",t);let e=t.message?.includes("429")||t.message?.includes("quota")||t.message?.includes("rate limit");return f.NextResponse.json({error:e?"AI quota exceeded. Try again later.":"Failed to generate habit stacks",details:t.message||"Unknown error",isRateLimit:e},{status:e?429:500})}}e.s(["POST",()=>w],33951);var R=e.i(33951);let S=new t.AppRouteRouteModule({definition:{kind:i.RouteKind.APP_ROUTE,page:"/api/ai/suggest-habit-stacks/route",pathname:"/api/ai/suggest-habit-stacks",filename:"route",bundlePath:""},distDir:".next",relativeProjectDir:"",resolvedPagePath:"[project]/src/app/api/ai/suggest-habit-stacks/route.ts",nextConfigOutput:"",userland:R}),{workAsyncStorage:$,workUnitAsyncStorage:I,serverHooks:T}=S;function A(){return(0,r.patchFetch)({workAsyncStorage:$,workUnitAsyncStorage:I})}async function C(e,t,r){S.isDev&&(0,a.addRequestMeta)(e,"devRequestTimingInternalsEnd",process.hrtime.bigint());let f="/api/ai/suggest-habit-stacks/route";f=f.replace(/\/index$/,"")||"/";let v=await S.prepare(e,t,{srcPage:f,multiZoneDraftMode:!1});if(!v)return t.statusCode=400,t.end("Bad Request"),null==r.waitUntil||r.waitUntil.call(r,Promise.resolve()),null;let{buildId:x,params:k,nextConfig:w,parsedUrl:R,isDraftMode:$,prerenderManifest:I,routerServerContext:T,isOnDemandRevalidate:A,revalidateOnlyGenerated:C,resolvedPathname:P,clientReferenceManifest:q,serverActionsManifest:E}=v,j=(0,o.normalizeAppPath)(f),D=!!(I.dynamicRoutes[j]||I.routes[P]),N=async()=>((null==T?void 0:T.render404)?await T.render404(e,t,R,!1):t.end("This page could not be found"),null);if(D&&!$){let e=!!I.routes[P],t=I.dynamicRoutes[j];if(t&&!1===t.fallback&&!e){if(w.experimental.adapterPath)return await N();throw new y.NoFallbackError}}let H=null;!D||S.isDev||$||(H="/index"===(H=P)?"/":H);let M=!0===S.isDev||!D,O=D&&!M;E&&q&&(0,s.setManifestsSingleton)({page:f,clientReferenceManifest:q,serverActionsManifest:E});let _=e.method||"GET",U=(0,n.getTracer)(),B=U.getActiveScopeSpan(),W={params:k,prerenderManifest:I,renderOpts:{experimental:{authInterrupts:!!w.experimental.authInterrupts},cacheComponents:!!w.cacheComponents,supportsDynamicResponse:M,incrementalCache:(0,a.getRequestMeta)(e,"incrementalCache"),cacheLifeProfiles:w.cacheLife,waitUntil:r.waitUntil,onClose:e=>{t.on("close",e)},onAfterTaskError:void 0,onInstrumentationRequestError:(t,i,r,a)=>S.onRequestError(e,t,r,a,T)},sharedContext:{buildId:x}},G=new l.NodeNextRequest(e),L=new l.NodeNextResponse(t),F=c.NextRequestAdapter.fromNodeNextRequest(G,(0,c.signalFromNodeResponse)(t));try{let s=async e=>S.handle(F,W).finally(()=>{if(!e)return;e.setAttributes({"http.status_code":t.statusCode,"next.rsc":!1});let i=U.getRootSpanAttributes();if(!i)return;if(i.get("next.span_type")!==d.BaseServerSpan.handleRequest)return void console.warn(`Unexpected root span type '${i.get("next.span_type")}'. Please report this Next.js issue https://github.com/vercel/next.js`);let r=i.get("next.route");if(r){let t=`${_} ${r}`;e.setAttributes({"next.route":r,"http.route":r,"next.span_name":t}),e.updateName(t)}else e.updateName(`${_} ${f}`)}),o=!!(0,a.getRequestMeta)(e,"minimalMode"),l=async a=>{var n,l;let c=async({previousCacheEntry:i})=>{try{if(!o&&A&&C&&!i)return t.statusCode=404,t.setHeader("x-nextjs-cache","REVALIDATED"),t.end("This page could not be found"),null;let n=await s(a);e.fetchMetrics=W.renderOpts.fetchMetrics;let l=W.renderOpts.pendingWaitUntil;l&&r.waitUntil&&(r.waitUntil(l),l=void 0);let c=W.renderOpts.collectedTags;if(!D)return await (0,p.sendResponse)(G,L,n,W.renderOpts.pendingWaitUntil),null;{let e=await n.blob(),t=(0,m.toNodeOutgoingHttpHeaders)(n.headers);c&&(t[h.NEXT_CACHE_TAGS_HEADER]=c),!t["content-type"]&&e.type&&(t["content-type"]=e.type);let i=void 0!==W.renderOpts.collectedRevalidate&&!(W.renderOpts.collectedRevalidate>=h.INFINITE_CACHE)&&W.renderOpts.collectedRevalidate,r=void 0===W.renderOpts.collectedExpire||W.renderOpts.collectedExpire>=h.INFINITE_CACHE?void 0:W.renderOpts.collectedExpire;return{value:{kind:b.CachedRouteKind.APP_ROUTE,status:n.status,body:Buffer.from(await e.arrayBuffer()),headers:t},cacheControl:{revalidate:i,expire:r}}}}catch(t){throw(null==i?void 0:i.isStale)&&await S.onRequestError(e,t,{routerKind:"App Router",routePath:f,routeType:"route",revalidateReason:(0,u.getRevalidateReason)({isStaticGeneration:O,isOnDemandRevalidate:A})},!1,T),t}},d=await S.handleResponse({req:e,nextConfig:w,cacheKey:H,routeKind:i.RouteKind.APP_ROUTE,isFallback:!1,prerenderManifest:I,isRoutePPREnabled:!1,isOnDemandRevalidate:A,revalidateOnlyGenerated:C,responseGenerator:c,waitUntil:r.waitUntil,isMinimalMode:o});if(!D)return null;if((null==d||null==(n=d.value)?void 0:n.kind)!==b.CachedRouteKind.APP_ROUTE)throw Object.defineProperty(Error(`Invariant: app-route received invalid cache entry ${null==d||null==(l=d.value)?void 0:l.kind}`),"__NEXT_ERROR_CODE",{value:"E701",enumerable:!1,configurable:!0});o||t.setHeader("x-nextjs-cache",A?"REVALIDATED":d.isMiss?"MISS":d.isStale?"STALE":"HIT"),$&&t.setHeader("Cache-Control","private, no-cache, no-store, max-age=0, must-revalidate");let y=(0,m.fromNodeOutgoingHttpHeaders)(d.value.headers);return o&&D||y.delete(h.NEXT_CACHE_TAGS_HEADER),!d.cacheControl||t.getHeader("Cache-Control")||y.get("Cache-Control")||y.set("Cache-Control",(0,g.getCacheControlHeader)(d.cacheControl)),await (0,p.sendResponse)(G,L,new Response(d.value.body,{headers:y,status:d.value.status||200})),null};B?await l(B):await U.withPropagatedContext(e.headers,()=>U.trace(d.BaseServerSpan.handleRequest,{spanName:`${_} ${f}`,kind:n.SpanKind.SERVER,attributes:{"http.method":_,"http.target":e.url}},l))}catch(t){if(t instanceof y.NoFallbackError||await S.onRequestError(e,t,{routerKind:"App Router",routePath:j,routeType:"route",revalidateReason:(0,u.getRevalidateReason)({isStaticGeneration:O,isOnDemandRevalidate:A})},!1,T),D)throw t;return await (0,p.sendResponse)(G,L,new Response(null,{status:500})),null}}e.s(["handler",()=>C,"patchFetch",()=>A,"routeModule",()=>S,"serverHooks",()=>T,"workAsyncStorage",()=>$,"workUnitAsyncStorage",()=>I],58445)},85685,e=>{e.v(e=>Promise.resolve().then(()=>e(54799)))},91961,e=>{e.v(t=>Promise.all(["server/chunks/[root-of-the-server]__c130a00c._.js"].map(t=>e.l(t))).then(()=>t(12111)))},72331,e=>{e.v(t=>Promise.all(["server/chunks/[root-of-the-server]__10e35c3a._.js","server/chunks/[root-of-the-server]__c08a7b0d._.js","server/chunks/[root-of-the-server]__5ddcde7c._.js"].map(t=>e.l(t))).then(()=>t(20442)))}];

//# sourceMappingURL=%5Broot-of-the-server%5D__bd868af7._.js.map