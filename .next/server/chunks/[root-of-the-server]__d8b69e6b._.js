...
Make it inspiring, evidence-based, and actionable!`}e.s(["coachBriefingSchema",0,{type:"object",properties:{greeting:{type:"string"},focus:{type:"string"},quote:{type:"string"},energyForecast:{type:"string",enum:["low","medium","high"]},streaksAtRisk:{type:"array",items:{type:"string"}},quickWins:{type:"array",items:{type:"string"}},goalsDeadline:{type:"string"},weekMomentum:{type:"string",enum:["up","down","stable"]}},required:["greeting","focus","quote"]},"habitDescriptionSchema",0,{type:"object",properties:{description:{type:"string"},benefits:{type:"array",items:{type:"string"},minItems:3,maxItems:5},tips:{type:"array",items:{type:"string"},minItems:3,maxItems:5},difficultyAssessment:{type:"string",enum:["beginner","intermediate","advanced"]},estimatedTimeMinutes:{type:"number"},scientificBacking:{type:"string"},commonPitfalls:{type:"array",items:{type:"string"},maxItems:3}},required:["description","benefits","tips","difficultyAssessment","estimatedTimeMinutes"]},"habitRecommendationSchema",0,t,"habitStackingSchema",0,r,"milestoneGenerationSchema",0,i,"quotePersonalizationSchema",0,a,"subtaskGenerationSchema",0,{type:"object",properties:{subtasks:{type:"array",items:{type:"string"},minItems:3,maxItems:5}},required:["subtasks"]},"taskPrioritySchema",0,{type:"object",properties:{taskId:{type:"string"},suggestedPriority:{type:"string",enum:["low","medium","high"]},reasoning:{type:"string"},estimatedDuration:{type:"string"},bestTimeSlot:{type:"string"},dependencies:{type:"array",items:{type:"string"}},urgencyScore:{type:"number",minimum:0,maximum:100}},required:["taskId","suggestedPriority","reasoning","urgencyScore"]}],16828),e.s(["buildCoachPrompt",()=>n,"buildHabitDescriptionPrompt",()=>p,"buildHabitRecommendationPrompt",()=>o,"buildHabitStackingPrompt",()=>d,"buildMilestoneGenerationPrompt",()=>c,"buildPrioritizePrompt",()=>s,"buildQuotePersonalizationPrompt",()=>u,"buildSubtaskPrompt",()=>l],73486)},82804,e=>{"use strict";var t=e.i(47909),i=e.i(74017),r=e.i(96250),a=e.i(59756),n=e.i(61916),s=e.i(74677),o=e.i(69741),l=e.i(16795),c=e.i(87718),d=e.i(95169),u=e.i(47587),p=e.i(66012),m=e.i(70101),g=e.i(26937),h=e.i(10372),y=e.i(93695);e.i(52474);var b=e.i(5232),f=e.i(89171),v=e.i(90706),x=e.i(16828),k=e.i(73486);async function w(e){try{let t;try{t=await e.json()}catch(e){return f.NextResponse.json({error:"Invalid request body"},{status:400})}let i=t;if(!i.goal||!i.goal.id||!i.goal.title)return f.NextResponse.json({error:"Goal information is required"},{status:400});let r=new v.HabitFlowAI("dashboard"),a=(0,k.buildMilestoneGenerationPrompt)(i),n=i.userContext?.timelinePreference||"balanced",s=`milestones:${i.goal.id}:${n}`,o=await r.generate("generate-milestones",a,x.milestoneGenerationSchema,s,604800);return o.goalId=i.goal.id,f.NextResponse.json(o)}catch(t){console.error("Milestone Generation Route Error:",t);let e=t.message?.includes("429")||t.message?.includes("quota")||t.message?.includes("rate limit");return f.NextResponse.json({error:e?"AI quota exceeded. Try again later.":"Failed to generate milestones",details:t.message||"Unknown error",isRateLimit:e},{status:e?429:500})}}e.s(["POST",()=>w],64356);var R=e.i(64356);let $=new t.AppRouteRouteModule({definition:{kind:i.RouteKind.APP_ROUTE,page:"/api/ai/generate-milestones/route",pathname:"/api/ai/generate-milestones",filename:"route",bundlePath:""},distDir:".next",relativeProjectDir:"",resolvedPagePath:"[project]/src/app/api/ai/generate-milestones/route.ts",nextConfigOutput:"",userland:R}),{workAsyncStorage:S,workUnitAsyncStorage:I,serverHooks:T}=$;function C(){return(0,r.patchFetch)({workAsyncStorage:S,workUnitAsyncStorage:I})}async function P(e,t,r){$.isDev&&(0,a.addRequestMeta)(e,"devRequestTimingInternalsEnd",process.hrtime.bigint());let f="/api/ai/generate-milestones/route";f=f.replace(/\/index$/,"")||"/";let v=await $.prepare(e,t,{srcPage:f,multiZoneDraftMode:!1});if(!v)return t.statusCode=400,t.end("Bad Request"),null==r.waitUntil||r.waitUntil.call(r,Promise.resolve()),null;let{buildId:x,params:k,nextConfig:w,parsedUrl:R,isDraftMode:S,prerenderManifest:I,routerServerContext:T,isOnDemandRevalidate:C,revalidateOnlyGenerated:P,resolvedPathname:A,clientReferenceManifest:q,serverActionsManifest:E}=v,j=(0,o.normalizeAppPath)(f),D=!!(I.dynamicRoutes[j]||I.routes[A]),N=async()=>((null==T?void 0:T.render404)?await T.render404(e,t,R,!1):t.end("This page could not be found"),null);if(D&&!S){let e=!!I.routes[A],t=I.dynamicRoutes[j];if(t&&!1===t.fallback&&!e){if(w.experimental.adapterPath)return await N();throw new y.NoFallbackError}}let M=null;!D||$.isDev||S||(M="/index"===(M=A)?"/":M);let H=!0===$.isDev||!D,O=D&&!H;E&&q&&(0,s.setManifestsSingleton)({page:f,clientReferenceManifest:q,serverActionsManifest:E});let _=e.method||"GET",U=(0,n.getTracer)(),G=U.getActiveScopeSpan(),B={params:k,prerenderManifest:I,renderOpts:{experimental:{authInterrupts:!!w.experimental.authInterrupts},cacheComponents:!!w.cacheComponents,supportsDynamicResponse:H,incrementalCache:(0,a.getRequestMeta)(e,"incrementalCache"),cacheLifeProfiles:w.cacheLife,waitUntil:r.waitUntil,onClose:e=>{t.on("close",e)},onAfterTaskError:void 0,onInstrumentationRequestError:(t,i,r,a)=>$.onRequestError(e,t,r,a,T)},sharedContext:{buildId:x}},W=new l.NodeNextRequest(e),L=new l.NodeNextResponse(t),F=c.NextRequestAdapter.fromNodeNextRequest(W,(0,c.signalFromNodeResponse)(t));try{let s=async e=>$.handle(F,B).finally(()=>{if(!e)return;e.setAttributes({"http.status_code":t.statusCode,"next.rsc":!1});let i=U.getRootSpanAttributes();if(!i)return;if(i.get("next.span_type")!==d.BaseServerSpan.handleRequest)return void console.warn(`Unexpected root span type '${i.get("next.span_type")}'. Please report this Next.js issue https://github.com/vercel/next.js`);let r=i.get("next.route");if(r){let t=`${_} ${r}`;e.setAttributes({"next.route":r,"http.route":r,"next.span_name":t}),e.updateName(t)}else e.updateName(`${_} ${f}`)}),o=!!(0,a.getRequestMeta)(e,"minimalMode"),l=async a=>{var n,l;let c=async({previousCacheEntry:i})=>{try{if(!o&&C&&P&&!i)return t.statusCode=404,t.setHeader("x-nextjs-cache","REVALIDATED"),t.end("This page could not be found"),null;let n=await s(a);e.fetchMetrics=B.renderOpts.fetchMetrics;let l=B.renderOpts.pendingWaitUntil;l&&r.waitUntil&&(r.waitUntil(l),l=void 0);let c=B.renderOpts.collectedTags;if(!D)return await (0,p.sendResponse)(W,L,n,B.renderOpts.pendingWaitUntil),null;{let e=await n.blob(),t=(0,m.toNodeOutgoingHttpHeaders)(n.headers);c&&(t[h.NEXT_CACHE_TAGS_HEADER]=c),!t["content-type"]&&e.type&&(t["content-type"]=e.type);let i=void 0!==B.renderOpts.collectedRevalidate&&!(B.renderOpts.collectedRevalidate>=h.INFINITE_CACHE)&&B.renderOpts.collectedRevalidate,r=void 0===B.renderOpts.collectedExpire||B.renderOpts.collectedExpire>=h.INFINITE_CACHE?void 0:B.renderOpts.collectedExpire;return{value:{kind:b.CachedRouteKind.APP_ROUTE,status:n.status,body:Buffer.from(await e.arrayBuffer()),headers:t},cacheControl:{revalidate:i,expire:r}}}}catch(t){throw(null==i?void 0:i.isStale)&&await $.onRequestError(e,t,{routerKind:"App Router",routePath:f,routeType:"route",revalidateReason:(0,u.getRevalidateReason)({isStaticGeneration:O,isOnDemandRevalidate:C})},!1,T),t}},d=await $.handleResponse({req:e,nextConfig:w,cacheKey:M,routeKind:i.RouteKind.APP_ROUTE,isFallback:!1,prerenderManifest:I,isRoutePPREnabled:!1,isOnDemandRevalidate:C,revalidateOnlyGenerated:P,responseGenerator:c,waitUntil:r.waitUntil,isMinimalMode:o});if(!D)return null;if((null==d||null==(n=d.value)?void 0:n.kind)!==b.CachedRouteKind.APP_ROUTE)throw Object.defineProperty(Error(`Invariant: app-route received invalid cache entry ${null==d||null==(l=d.value)?void 0:l.kind}`),"__NEXT_ERROR_CODE",{value:"E701",enumerable:!1,configurable:!0});o||t.setHeader("x-nextjs-cache",C?"REVALIDATED":d.isMiss?"MISS":d.isStale?"STALE":"HIT"),S&&t.setHeader("Cache-Control","private, no-cache, no-store, max-age=0, must-revalidate");let y=(0,m.fromNodeOutgoingHttpHeaders)(d.value.headers);return o&&D||y.delete(h.NEXT_CACHE_TAGS_HEADER),!d.cacheControl||t.getHeader("Cache-Control")||y.get("Cache-Control")||y.set("Cache-Control",(0,g.getCacheControlHeader)(d.cacheControl)),await (0,p.sendResponse)(W,L,new Response(d.value.body,{headers:y,status:d.value.status||200})),null};G?await l(G):await U.withPropagatedContext(e.headers,()=>U.trace(d.BaseServerSpan.handleRequest,{spanName:`${_} ${f}`,kind:n.SpanKind.SERVER,attributes:{"http.method":_,"http.target":e.url}},l))}catch(t){if(t instanceof y.NoFallbackError||await $.onRequestError(e,t,{routerKind:"App Router",routePath:j,routeType:"route",revalidateReason:(0,u.getRevalidateReason)({isStaticGeneration:O,isOnDemandRevalidate:C})},!1,T),D)throw t;return await (0,p.sendResponse)(W,L,new Response(null,{status:500})),null}}e.s(["handler",()=>P,"patchFetch",()=>C,"routeModule",()=>$,"serverHooks",()=>T,"workAsyncStorage",()=>S,"workUnitAsyncStorage",()=>I],82804)},85685,e=>{e.v(e=>Promise.resolve().then(()=>e(54799)))},91961,e=>{e.v(t=>Promise.all(["server/chunks/[root-of-the-server]__c130a00c._.js"].map(t=>e.l(t))).then(()=>t(12111)))},72331,e=>{e.v(t=>Promise.all(["server/chunks/[root-of-the-server]__7dbec23f._.js","server/chunks/[root-of-the-server]__c08a7b0d._.js","server/chunks/[root-of-the-server]__5ddcde7c._.js"].map(t=>e.l(t))).then(()=>t(20442)))}];

//# sourceMappingURL=%5Broot-of-the-server%5D__d8b69e6b._.js.map